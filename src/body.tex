...
In the beginning of this work, I have described the research progress in \ac{AI} and how new neural network based
systems are able to solve problems, previously only solvable by humans. I have also indicated the obvious incentive to
...
competitiveness, \ac{PowerTAC} contenders must also be enabled to pursue these technologies to realistically represent
