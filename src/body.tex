...
This section describes the development of the demand estimator using \ac{NN} technologies. It also describes the issues
I ran into when designing this model, which are common issues when designing prediction models using \ac{NN}.
...
environment\cite[p.469ff.]{sutton2018reinforcement}. While the Atari agents often receive their reward directly from the
