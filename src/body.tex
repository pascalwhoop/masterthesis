...
% - research in \ac{SL} and \ac{RL} has seen huge improvements in recent years, thanks to neural network
...
its sub fields of \ac{SL} and \ac{UL} will be introduced. Here,  I will focus on the area of neural networks and a way to let
them learn through Backpropagation. In the field of \ac{RL} I will focus on the \ac{MDP} framework as well as the
\ac{POMDP} subclass.  Next follows an introduction of the recent research in using neural networks in \ac{RL} settings to allow
...
games and simulates the necessary events. The following trials were executed:


\begin{table}[]
\resizebox{\textwidth}{!}{%
    \begin{tabular}{l|l|l|l|l|l}
        \textbf{Agent Type} & \textbf{Preprocessing} & \textbf{Action T} & \textbf{NW} & \textbf{r type} & \textbf{r after 30 games} \\ \hline
DQN                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
DQN                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
VPG                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & bandit            & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & discrete          & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & none                   & continuous        & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & bandit            & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & discrete          & vnn32x2     & $r_{rel}$       &                           \\
PPO                         & MinMax                 & continuous        & vnn32x2     & $r_{rel}$       &                           \\
