...
set shortmess=aoO
badd +0 chaps/body.tex
badd +0 bibliography.bib
badd +1 acronyms.tex
badd +0 thesis.vim
argglobal
silent! argdel *
...
exe '1resize ' . ((&lines * 71 + 43) / 86)
exe 'vert 1resize ' . ((&columns * 158 + 173) / 346)
exe '2resize ' . ((&lines * 12 + 43) / 86)
exe 'vert 2resize ' . ((&columns * 46 + 173) / 346)
exe '3resize ' . ((&lines * 12 + 43) / 86)
exe 'vert 3resize ' . ((&columns * 111 + 173) / 346)
exe 'vert 4resize ' . ((&columns * 86 + 173) / 346)
exe 'vert 5resize ' . ((&columns * 100 + 173) / 346)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
52
normal! zc
let s:l = 14 - ((11 * winheight(0) + 35) / 71)
...
wincmd w
argglobal
edit /usr/share/vim/vim80/doc/syntax.txt
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 3430 - ((41 * winheight(0) + 42) / 84)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
3430
